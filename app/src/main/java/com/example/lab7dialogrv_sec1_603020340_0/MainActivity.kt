package com.example.lab7dialogrv_sec1_603020340_0
...
class MainActivity : AppCompatActivity() {
    ...
    fun addStudent(v: View) {
        ...
        mDialogView.btnAdd.setOnClickListener{
            ...
            Toast.makeText(applicationContext, "The student is added successful", Toast.LENGTH_SHORT).show()
    ...
    fun testStudentData(){
        studentList.add(Student("603020340-0", "Student 1", 20))
        studentList.add(Student("603020340-0", "Student 2", 21))
    }
}
